...
void LCD_Init(void)
{
	...
	MCAL_GPIO_WritePin(LCD_CTRL_PORT, LCD_RW_PIN, LCD_WRITE);
	_delay_ms(15);
	...
	config.pinNumber = GPIO_PIN4;
	config.pinMode = GPIO_MODE_OUTPUT;
	MCAL_GPIO_Init(LCD_DATA_PORT, &config);
	
	config.pinNumber = GPIO_PIN5;
	config.pinMode = GPIO_MODE_OUTPUT;
	MCAL_GPIO_Init(LCD_DATA_PORT, &config);
	
	config.pinNumber = GPIO_PIN6;
	config.pinMode = GPIO_MODE_OUTPUT;
	MCAL_GPIO_Init(LCD_DATA_PORT, &config);
	
	config.pinNumber = GPIO_PIN7;
	config.pinMode = GPIO_MODE_OUTPUT;
	MCAL_GPIO_Init(LCD_DATA_PORT, &config);
...
void LCD_Send_Command(uint8_t command)
{
	...
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN4, READ_BIT(command, 4));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN5, READ_BIT(command, 5));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN6, READ_BIT(command, 6));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN7, READ_BIT(command, 7));
	...
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN4, READ_BIT(command, 0));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN5, READ_BIT(command, 1));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN6, READ_BIT(command, 2));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN7, READ_BIT(command, 3));
	LCD_Enable_Pulse();
#endif
}
...
void LCD_Send_Char(uint8_t data)
{
	...
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN4, READ_BIT(data, 4));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN5, READ_BIT(data, 5));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN6, READ_BIT(data, 6));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN7, READ_BIT(data, 7));
	...
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN4, READ_BIT(data, 0));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN5, READ_BIT(data, 1));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN6, READ_BIT(data, 2));
	MCAL_GPIO_WritePin(LCD_DATA_PORT, GPIO_PIN7, READ_BIT(data, 3));
	LCD_Enable_Pulse();
#endif
	charCounter++;
}
...
void LCD_Busy_Wait()
{
	...
	MCAL_GPIO_WritePin(LCD_CTRL_PORT, LCD_RW_PIN, LCD_READ);		/*RW = 1      Read from LCD*/
